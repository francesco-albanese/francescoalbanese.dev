...
export function WelcomeBox({ profilePictureSrc }: WelcomeBoxProps) {
	return (
		<div className="relative border border-coral rounded mb-4 sm:mb-8 w-fit max-w-full">
			...
			<div className="flex flex-col md:flex-row">
				<div className="p-3 pt-6 sm:p-4 sm:pt-8 md:p-6 md:pt-8 min-w-0 flex flex-col items-center justify-center">
...
/_/  |_/_/_.___/\\__,_/_/ /_/\\___/____/\\___/`}
					...
					<div className="mt-10 font-mono text-xs text-center">
						...
						<p className="hidden sm:block text-secondary mt-0.5">Python · TypeScript · AI · AWS</p>
					</div>
				</div>
